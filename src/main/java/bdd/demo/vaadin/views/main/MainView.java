package bdd.demo.vaadin.views.main;
...
import bdd.demo.vaadin.views.masterdetail.MasterDetailView;
import bdd.demo.vaadin.views.cardlist.CardListView;
import bdd.demo.vaadin.views.form.FormView;
...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new H1("VaadinApp"));
